    ...
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        body: ChangeNotifierProvider(
          ...
          child: InputTransactionContent(listData: _listMenuMerchant, callback: _callbackMenuMerchant,)),
      ),
    );
  }
}
...
class InputTransactionContent extends StatefulWidget {
  ...
  InputTransactionContent({super.key, required this.listData, required this.callback});
                                          ...
                                          Column(
                                            children: [
                                              for(var i = 0; i < widget.listData.length; i ++)...{
                                                if(selectedMenu.containsKey(widget.listData[i].id))...{
                                                  rowItemDetail(context, selectedMenu[widget.listData[i].id]!)
                                                }
                                              }
                                            ],
                                          )
                            ...
                            children: [
                              Container(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    const Text("Total:", style: TrxTxtStyle.totTagihanText,),
                                    Text(menuMerchantProvider.getTotalTransaksi() > 0 ?
                                    Utils().formatCurrency(menuMerchantProvider.getTotalTransaksi().toString(), "") : "Rp 0",
                                    ...
                                    Row(
                                      ...
                                      children: [
                                        Column(
                                          crossAxisAlignment: CrossAxisAlignment.start,
                                          children: [
                                            Text(widget.listData[index].nama_menu_merchant, style: TrxTxtStyle.nmMenuText,),
                                            Text(Utils().formatCurrency(
                                              widget.listData[index].harga, "nonSymbol"), 
                                            ...
                                            Container(
                                              ...
                                              child: Row(
                                                ...
                                                children: [
                                                  InkWell(
                                                    onTap: (){
                                                      menuMerchantProvider.removeMenu(widget.listData[index]);
                                                    },
                                                    child: Container(
                                                  ...
                                                  Text(selectedMenu.containsKey(widget.listData[index].id) ?
                                                    selectedMenu[widget.listData[index].id]!.selectedCount.toString() : 
                                                    "0", 
                                                      style: selectedMenu.containsKey(widget.listData[index].id) ? TrxTxtStyle.qtyText : TrxTxtStyle.qtyTextZero,),
                                                  InkWell(
                                                    onTap: (){
                                                      menuMerchantProvider.addMenu(widget.listData[index]);
                                                    },
                                                    child: Container(
                                                      padding: const EdgeInsets.all(2),
                                                      decoration: BoxDecoration(
                                        ...
                                        children: [
                                          ...
                                          SizedBox(
                                            ...
                                            child: Text(
                                              ...
                                              selectedMenu.containsKey(widget.listData[index].id) ? 
                                                Utils().formatCurrency((selectedMenu[widget.listData[index].id]!.selectedCount * int.parse(selectedMenu[widget.listData[index].id]!.harga)).toString(), "nonSymbol")
                                              : "0",
                                            style: selectedMenu.containsKey(widget.listData[index].id) ? TrxTxtStyle.valTotal : TrxTxtStyle.valTotalZero,
...
Widget rowItemDetail(
  ...
  MenuMerchantModel item) => Container(
    ...
    children: [
          ...
          return Row(
            ...
            children: [
              Container(
                ...
                child: Text(item.nama_menu_merchant, style: TrxTxtStyle.lblDetailItem,),
              ),
              // Text(Utils().formatCurrency(totalHarga, "nonSymbol"),
              Text(Utils().formatCurrency((int.parse(item.harga) * item.selectedCount).toString(), "nonSymbol"),
      ...
      Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text("${item.selectedCount.toString()}  x ${Utils().formatCurrency(item.harga, "nonSymbol")}", style: TrxTxtStyle.lblHrgSatuanItem,),
          InkWell(
            onTap: (){
