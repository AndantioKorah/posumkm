        ...
        body: _showLoader
            ...
            : SafeArea(
              child: Stack(children: [
                ...
                Container(
                  padding: EdgeInsets.only(bottom: sizeScreen.size.height * .102),
                  child: SingleChildScrollView(
                    child: Container(
                      // height: 100,
                      // padding: EdgeInsets.only(bottom: sizeScreen.size.height * .005),
                                ...
                                TransactionController.createPembayaran(
                                  ...
                                  if (value.code != 200 &&
                                    ...
                                    context, MaterialPageRoute(
                                        builder: (context) => const TransactionPage()),(route) => false,
                                    );
                                  }
                                });
                              },
