                                ...
                                // if(widget.master == "jenis"){
                                  ...
                                  if(searchValue.isNotEmpty){
                                    tempForEach.forEach((rs) {
                                      if(rs.nama_jenis_menu.toLowerCase().contains(searchValue.toLowerCase())){
            ...
            child: Container(
              ...
              child: TextField(
                ...
                onChanged: (searchValue) {
                  ...
                  // ignore: unrelated_type_equality_checks
                  if(widget.master == "jenis"){
                    List<JenisMenuModel> tempForEach = _temp as List<JenisMenuModel>;
                    List<JenisMenuModel> tempJenisMenu = [];
                    if(searchValue.isNotEmpty){
                      tempForEach.forEach((rs) {
                        if(rs.nama_jenis_menu.toLowerCase().contains(searchValue.toLowerCase())){
...
Widget showMenuMerchantList(List<MenuMerchantModel> data) => ListView.builder(
  ...
  itemBuilder: (context, index) {
    var jenisMenu = data[index].nama_jenis_menu != "" ? data[index].nama_jenis_menu : "-" ;
    var kategoriMenu = data[index].nama_kategori_menu != "" ? data[index].nama_kategori_menu : "-" ;
